      ...
      <div className={styles.main}>
        ...
        <div>
          ...
          <p className={styles.tagline}>
            Professionelle Gartenpflege &amp; Reinigung in Wiener Neustadt
            und Umgebung — sorgfältig und zu fairen Preisen.
          </p>
        ...
        <div className={styles.col}>
          ...
          <ul>
            {[
              ...
              { l: 'Referenzen', h: '#vorher-nachher' },
              { l: 'Kontakt', h: '#kontakt' },
              { l: 'Impressum', h: '/impressum' },
              { l: 'Datenschutz', h: '/datenschutz' },
            ].map(({ l, h }) => <li key={l}><a href={h}>{l}</a></li>)}
          </ul>
        </div>
      </div>
